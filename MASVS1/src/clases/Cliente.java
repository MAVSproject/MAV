...
public class Cliente extends Usuario {
    ...
    public Cliente(int codigo, String nombre, String apellido, String usuario, String telefono, String direccion, String contraseña) {
    ...
    JOptionPane.showMessageDialog(null, "Codigo: "+codigo+"\n"+"Nombre: "+nombre+"\n"+"Apellido: "+apellido+"\n"+"Usuario: "+usuario+"\n"+"Telefono: "+telefono+"\n"+"Direccion: "+direccion+"\n"+"Contraseña: "+contraseña,"Cliente ", JOptionPane.INFORMATION_MESSAGE);
